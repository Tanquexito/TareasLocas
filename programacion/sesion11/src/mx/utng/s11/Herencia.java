...
public class Herencia {
    public static void main(String[] args) {
        Triangulo triangulo=new Triangulo(4, 5, "Estilo loco");
        ...
        //
        Triangulo triangulo2=new Triangulo(10, 500, "Estilo Romantico");
        System.out.println("Informacion sobre triangulo: ");
        triangulo2.mostrarDimension();
        triangulo2.mostrarEstilo();
        System.out.println("El area del triangulo es: "+ triangulo2.area());
        //
        Triangulo triangulo3=new Triangulo(150, 300, "Estilo Caramelo");
        System.out.println("Informacion sobre triangulo: ");
